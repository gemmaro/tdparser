...
Note: TDParser is a successor of TDP4R.
...
then call the parse[rdoc-ref:TDParser::Parser#parse] method of a
parser object, which is created by <tt>MyParser.new()</tt>, as
follows.
